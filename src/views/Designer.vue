        ...
        <div class="image-and-text flex w-9/12 h-1/2 my-5 justify-center items-center tablet:w-11.5/12 tablet:h-auto ">
          ...
          <div class="h-80 w-1/2 image flex justify-center items-center bg-gray-600">
            <div class="w-full h-full bg-black object-contain">
              <img :src="getFront" :alt=designer.name class="object-cover h-full w-full">
            </div>
          </div>
          <!-- end of image -->
...
export default {
  ...
  computed: {
    ...
    getFront () {
      return require("../assets/images/artists/design" + this.designer.photos.front);
    },
    getSide () {
      return require("../assets/images/artists/design" + this.designer.photos.side);
    },
    getBack () {
      return require("../assets/images/artists/design" + this.designer.photos.back);
    },
  },
  methods: {
    getDesigner () {
      this.designer = this.designers(this.$route.params.name);
    },
  },
